...
using StoreHouse.XF.Base.Extensions;
using Xamarin.Forms;

namespace StoreHouse.XF.Base.UI
{
    public class PopupPageAnimation : Rg.Plugins.Popup.Interfaces.Animations.IPopupAnimation
    {
        public void Preparing(View content, PopupPage page)
        {
            page.IsVisible = false;
            page.BackgroundColor = Color.Black.MultiplyAlpha(0.15);
            if (content == null) return;

            content.TranslationY = Device.Info.ScaledScreenSize.Height;
        ...
        public async Task Appearing(View content, PopupPage page)
        {
            ...
            if (content != null)
            {
                ...
                taskList.Add(page.ColorTo(page.BackgroundColor, Color.Black.MultiplyAlpha(0.6),
            ...
            if (_previous?.Content != null)
            {
                ...
                //taskList.Add(page.ColorTo(page.BackgroundColor, Colors.PopupBackColor,
                //color => page.BackgroundColor = color, Duration, EasingOut));
            }
        ...
        public async Task Disappearing(View content, PopupPage page)
        {
            ...
            if (content != null)
            {
                taskList.Add(content.TranslateTo(content.TranslationX, Device.Info.ScaledScreenSize.Height,
                    Duration, EasingOut));
